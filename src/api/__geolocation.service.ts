...
//       params: this.params,
//       url:
//         'https://my.borobudurmarathon.com/dev.titudev.com/api/v1/lumbini/log_myborobudur/' +
...
//         message:
//           'This app collects location data to enable activity recording and calculate travelled distance for both exercise and running activities',
...
//         instructions:
//           'You should enable "Always" in Location Services, to allow App work properly in the background',
//         cancelButton: 'Cancel',
...
//       BackgroundGeolocation.requestTemporaryFullAccuracy('Running')
